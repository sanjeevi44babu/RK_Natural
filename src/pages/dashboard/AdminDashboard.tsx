...
import { 
  Users, UserCog, Activity, Calendar, Bell, ChevronRight, 
  ClipboardList, Eye, Shield
} from 'lucide-react';
  ...
  return (
    <DashboardLayout>
      <div className="p-4 lg:p-6 space-y-6">
          ...
          <div className="flex items-start justify-between mb-4">
            ...
            <button className="p-2 rounded-xl bg-white/10 hover:bg-white/20 transition-colors relative">
              ...
              {stats.pendingApprovals > 0 && (
                <span className="absolute -top-1 -right-1 w-5 h-5 bg-destructive text-xs flex items-center justify-center rounded-full">
        ...
        {stats.pendingApprovals > 0 && (
          <div 
            className="card-medical bg-warning/10 border-warning/30 cursor-pointer"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
          ...
          >
            ...
            <span className="flex-1 text-left font-medium">View Therapists</span>
            <ChevronRight size={20} className="text-muted-foreground" />
          </button>
